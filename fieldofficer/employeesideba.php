...
<div class="sidebar-menu">
  ...
  <li id="menu-academico" ><a href="#"  style="padding: 9px;"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Registration</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   <ul id="menu-academico-sub" >
                                                                                ...
                                                                                <li id="menu-academico" ><a href="addnews.php"  style="padding: 9px;"><i class="fa fa-list-ul" aria-hidden="true"></i><span> News</span> <div class="clearfix"></div></a></li> 
                                                            <li id="menu-academico" ><a href="dcreport.php"  style="padding: 9px;"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Upload Reports</span> <div class="clearfix"></div></a></li>                                  
