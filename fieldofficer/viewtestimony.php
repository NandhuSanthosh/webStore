...
<html>
<head>
<title>Stock-Clearance/ Admin</title>
...
<div class="w3l-table-info" style="margin-left: -320px; overflow-x: auto;">
					  <h2>View Testimony </h2>
						...
						<tbody>
						  <?php
                                                  $qr="select  * from testimony order by Id desc";
                                                  ...
                                                  ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $r['Email'];?></td>
                                                         ...
                                                         <td><img src="../images/<?php echo $r['Image'];?>" width="60" height="60"/></td>                              
                                                         <td><?php 
                                                         if($r['Status']=='Inactive')
                                                         {
                                                         ?>
                                                             <a href="useractive.php?id=<?php echo $r['Id'];?>&s=<?php echo $r['Status'];?>">Active</a>
                                                             <?php 
                                                         }
 else {
     ?>
                                                             <a href="useractive.php?id=<?php echo $r['Id'];?>&s=<?php echo $r['Status'];?>">Inactive</a>                                                  
                                                             <?php 
 }
                                                             ?>
                                                             
                                                         </td><td>  <a href="deltestimony.php?id=<?php echo $r['Id'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"> </a></td>
