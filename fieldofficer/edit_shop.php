...
include '../db.php';
  ...
  {
    $id=$_GET['id'];
    $qr=mysqli_query($con,"select * from shop where Id=$id");
...
if($filename=='')
{
 $filepath=$old;   
    ...
    move_uploaded_file($f,"shop/".$filename);
    $path="shop/";
  ...
  $query="update shop set District='$district',Name='$station',Address='$address',Phone='$phone',Image='$filepath' where Id=$id";
