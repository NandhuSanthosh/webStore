...
<div>
    ...
    if(isset($_POST['sub']))
    {
        ...
        $q=  mysqli_query($con,"insert into category(Category) values('$txtname')");
...
<div class="w3l-table-info" style="margin-left: -320px; overflow-x: auto;">
					  <h2>View category</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select  * from category order by Id desc";
                                                  ...
                                                  ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="delcategoy.php?id=<?php echo $r['Id'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"> </a></td>
