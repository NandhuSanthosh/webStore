...
include './includes/header.php';
    ?>
      <!--//headder-->
      <!-- banner -->
      <div class="inner_page-banner one-img" style="background: url(images/sh5.webp);">
      </div>
      <!--//banner -->
      <!-- short -->
                  ...
                  <div class=" agile-wls-contact-mid">
                     <div class="form-group contact-forms">
                       ...
                       <div class="form-group contact-forms">
                         ...
                         <div class="form-group contact-forms">
                             <textarea class="form-control" name="addr" rows="3" placeholder="Address"></textarea>
                     </div>
                          <div class="form-group contact-forms">
                              <input type="number" name="pin" class="form-control" placeholder="PIN Code">
                     </div>
                     <div class="form-group contact-forms">
                         <input type="email" name="ema" class="form-control" placeholder="Email">
                     </div>
                     <div class="form-group contact-forms">
                      ...
                      <button type="submit" name="s1" class="btn btn-block sent-butnn">Register</button>
                  </div>
               </form>
                <?php 
                if(isset($_POST['s1']))
