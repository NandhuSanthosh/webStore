...
include '../db.php';
  ...
  {
    $id=$_GET['id'];
    $qr=mysqli_query($con,"select * from fieldofficer where Id=$id");
...
<div>
       <form class="form-horizontal" method ="POST" enctype="multipart/form-data">
               ...
               <div class="col-sm-8">
                <select class="form-control1" name="district" required="">
                  ...
                  while($r1=mysqli_fetch_array($qr))
                  {
                    ...
                    ?>
                    <option <?php if($r['District']==$r1['Id']){?> selected <?php } ?>value="<?php echo $r1['Id']; ?>" ><?php echo $r1['District']; ?></option>
                  <?php  } ?>
                </select>
            ...
            <div class="form-group">
             ...
             <div class="col-sm-8">
              <input type="text" class="form-control1" name="station" id="focusedinput" value="<?php echo $r['Station']; ?>" >
            </div>
...
if(isset($_POST['s1']))
{
  ...
  $query="update fieldofficer set District='$district',Station='$station',Address='$address',Phone='$phone' where Id=$id";
  ...
  if($result)
  {
    ...
    header("location:addfieldofficer.php?e=1");
  }
}
?>
</div>
