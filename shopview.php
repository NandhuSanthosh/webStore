         ...
         <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
            ...
            <div class="row">
               ...
               <div class="left-ads-display col-lg-12">
                  <div class="row">
                      <?php 
                      $qv=  mysqli_query($con,"select *from shop order by Id desc");
                                    ...
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          ...
                                          <div class="grid-price mt-2">
                                              <?php 
                                              $disid=$r2['District'];
                                              $qk=  mysqli_query($con, "select *from district where Id='$disid'");
                                              $rt1=  mysqli_fetch_array($qk);
                                              ?>
                                             <span class="money "><?php echo $rt1['District'];?></span>
                                          </div>
                                             <div class="grid-price mt-2">
                                           <span class="money "><?php echo $r2['Address'];?></span>
                                          </div>
                                            <div class="grid-price mt-2">
                                           <span class="money "><?php echo $r2['Phone'];?></span>
                                          </div>
                                             <div class="grid-price mt-2">
                                           <span class="money "><?php echo $r2['Email'];?></span>
                                          </div>
                                              <div class="grid-price mt-2">
                                                  <a href="" class="btn btn-info" >GO TO CART</a>
                                          </div>
                                       </div>
